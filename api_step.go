...
type StepAPI interface {
	...
	*/
	...
	//  @return map[string]interface{}
	ProductConfiguratorDeleteStepExecute(r ApiProductConfiguratorDeleteStepRequest) (map[string]interface{}, *http.Response, error)
...
//
//	@return map[string]interface{}
func (a *StepAPIService) ProductConfiguratorDeleteStepExecute(r ApiProductConfiguratorDeleteStepRequest) (map[string]interface{}, *http.Response, error) {
	var (
