...
// checks if the ConfigurationSelection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConfigurationSelection{}
...
func (o *ConfigurationSelection) GetOptionIds() []string {
...
// and a boolean to check if the value has been set.
func (o *ConfigurationSelection) GetOptionIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.OptionIds) {
		return nil, false
	}
...
func (o *ConfigurationSelection) HasOptionIds() bool {
	if o != nil && !IsNil(o.OptionIds) {
		return true
	}
...
func (o *ConfigurationSelection) SetOptionIds(v []string) {
	o.OptionIds = v
}
...
func (o ConfigurationSelection) ToMap() (map[string]interface{}, error) {
