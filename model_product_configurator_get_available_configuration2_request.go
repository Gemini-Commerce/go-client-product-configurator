...
func (o *ProductConfiguratorGetAvailableConfiguration2Request) GetSelections() []ConfigurationSelection {
...
func (o *ProductConfiguratorGetAvailableConfiguration2Request) GetSelectionsOk() ([]ConfigurationSelection, bool) {
	if o == nil || IsNil(o.Selections) {
		return nil, false
	}
...
func (o *ProductConfiguratorGetAvailableConfiguration2Request) SetSelections(v []ConfigurationSelection) {
	o.Selections = v
}
