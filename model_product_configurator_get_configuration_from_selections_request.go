...
func (o *ProductConfiguratorGetConfigurationFromSelectionsRequest) GetSelections() []ConfigurationSelection {
...
func (o *ProductConfiguratorGetConfigurationFromSelectionsRequest) GetSelectionsOk() ([]ConfigurationSelection, bool) {
	if o == nil || IsNil(o.Selections) {
		return nil, false
	}
...
func (o *ProductConfiguratorGetConfigurationFromSelectionsRequest) SetSelections(v []ConfigurationSelection) {
	o.Selections = v
}
